...
def cat_facts(number)
   ...
   wait_for_response(1, number)
   @v.sms("#{number}", "Thanks for texting Cat Fats! Now, every time you text you will receive an instant Cat Fact. To cancel, reply 'CAT FACTS: chrykutfgh5764gvhtfvkigdrf678'")
   wait_for_response(1, number)
